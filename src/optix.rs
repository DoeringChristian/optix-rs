...
impl OptixApi {
    ...
    pub unsafe fn optixDeviceContextSetCacheDatabaseSizes
        (
            ...
            self.ftable.optixDeviceContextSetCacheDatabaseSizes.unwrap()(context, lowWaterMark, highWaterMark)
        }
    ...
    pub unsafe fn optixDeviceContextGetCacheDatabaseSizes
        (
            ...
            self.ftable.optixDeviceContextGetCacheDatabaseSizes.unwrap()(context, lowWaterMark, highWaterMark)
        }
    pub unsafe fn optixModuleCreateFromPTX
        (
            ...
            self.ftable.optixModuleCreateFromPTX.unwrap()(context, moduleCompileOptions, pipelineCompileOptions,PTX, PTXsize, logString, logStringSize, module)
        }
    pub unsafe fn optixModuleCreateFromPTXWithTasks
        (
            ...
            self.ftable.optixModuleCreateFromPTXWithTasks.unwrap()(context, moduleCompileOptions, pipelineCompileOptions, PTX, PTXsize, logString, logStringSize, module, firstTask)
        }
    ...
    pub unsafe fn optixBuiltinISModuleGet
        (
            ...
            self.ftable.optixBuiltinISModuleGet.unwrap()(context, moduleCompileOptions, pipelineCompileOptions, builtinISOptions, builtinModule)
        }
    pub unsafe fn optixTaskExecute
        (
            ...
            self.ftable.optixTaskExecute.unwrap()(task, additionalTasks, maxNumAdditionalTasks, numAdditionalTasksCreated)
        }
    ...
    pub unsafe fn optixProgramGroupCreate
        (
            ...
            self.ftable.optixProgramGroupCreate.unwrap()(context, programDescriptions, numProgramGroups, options, logString, logStringSize, programGroups)
        }
    ...
    pub unsafe fn optixPipelineCreate
        (
            ...
            self.ftable.optixPipelineCreate.unwrap()(context, pipelineCompileOptions, pipelineLinkOptions, programGroups, numProgramGroups, logString, logStringSize, pipeline)
        }
    ...
    pub unsafe fn optixPipelineSetStackSize
        (
            ...
            self.ftable.optixPipelineSetStackSize.unwrap()(pipeline, directCallableStackSizeFromTraversal, directCallableStackSizeFromState, continuationStackSize, maxTraversableGraphDepth)
        }
    pub unsafe fn optixAccelComputeMemoryUsage
        (
            ...
            self.ftable.optixAccelComputeMemoryUsage.unwrap()(context, accelOptions, buildInputs, numBuildInputs, bufferSizes)
        }
    pub unsafe fn optixAccelBuild
        (
            ...
            self.ftable.optixAccelBuild.unwrap()(context, stream, accelOptions, buildInputs, numBuildInputs, tempBuffer, tempBufferSizeInBytes, outputBuffer, outputBufferSizeInBytes, outputHandle, emittedProperties, numEmittedProperties)
        }
    ...
    pub unsafe fn optixAccelRelocate
        (
            ...
            self.ftable.optixAccelRelocate.unwrap()(context, stream, info, instanceTraversableHandles, numInstanceTraversableHandles, targetAccel, targetAccelSizeInBytes, targetHandle)
        }
    pub unsafe fn optixAccelCompact
        (
            ...
            self.ftable.optixAccelCompact.unwrap()(context, stream, inputHandle, outputBuffer, outputBufferSizeInBytes, outputHandle)
        }
    pub unsafe fn optixConvertPointerToTraversableHandle
        (
            ...
            self.ftable.optixConvertPointerToTraversableHandle.unwrap()(onDevice, pointer, traversableType, traversableHandle)
        }
    ...
    pub unsafe fn optixLaunch
        (
            ...
            self.ftable.optixLaunch.unwrap()(pipeline, stream, pipelineParams, pipelineParamsSize, sbt, width, height, depth)
        }
    ...
    pub unsafe fn optixDenoiserComputeMemoryResources
        (
            ...
            self.ftable.optixDenoiserComputeMemoryResources.unwrap()(handle, maximumInputWidth, maximumInputHeight, returnSizes)
        }
    pub unsafe fn optixDenoiserSetup
        (
            ...
            self.ftable.optixDenoiserSetup.unwrap()(denoiser, stream, inputWidth, inputHeight, state, stateSizeInBytes, scratch, scratchSizeInBytes)
        }
    pub unsafe fn optixDenoiserInvoke
        (
            ...
            self.ftable.optixDenoiserInvoke.unwrap()(denoiser, stream, params, denoiserState, denoiserStateSizeInBytes, guideLayer, layers, numLayers, inputOffsetX, inputOffsetY, scratch, scratchSizeInBytes)
        }
    pub unsafe fn optixDenoiserComputeIntensity
        (
            ...
            self.ftable.optixDenoiserComputeIntensity.unwrap()(handle, stream, inputImage, outputIntensity, scratch, scratchSizeInBytes)
        }
    pub unsafe fn optixDenoiserComputeAverageColor
        (
            ...
            self.ftable.optixDenoiserComputeAverageColor.unwrap()(handle, stream, inputImage, outputAverageColor, scratch, scratchSizeInBytes)
        }
    pub unsafe fn optixDenoiserCreateWithUserModel
        (
            ...
            self.ftable.optixDenoiserCreateWithUserModel.unwrap()(context, data, dataSizeInBytes, returnHandle)
        }
}
